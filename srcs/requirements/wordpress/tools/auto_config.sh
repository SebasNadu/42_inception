...
if [ ! -f "/var/www/html/index.html" ]; then
    ...
    wp config create --dbname=$WP_DATABASE_NAME --dbuser=$WP_DATABASE_USR --dbpass=$WP_DATABASE_PWD --dbhost=$MYSQL_HOST --path="/var/www/html/wordpress" --dbcharset="utf8mb4" --dbcollate="utf8mb4_general_ci" --allow-root
